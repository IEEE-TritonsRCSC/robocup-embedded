...
void PID_Outputs::setPout(float p) {this->pout = pout;}
void PID_Outputs::setIout(float i);
void PID_Outputs::setDout(float d);

float PID_Outputs::getPout();
float PID_Outputs::getIout();
float PID_Outputs::getDout();
};
