...
PID_Data motor1Data(9999, 1000, 20, 0, motor1_gains);
PID_Data motor2(9999, 1000, 20, 0, motor2_gains);
PID_Data motor3(9999, 1000, 20, 0, motor3_gains);
PID_Data motor4(9999, 1000, 20, 0, motor4_gains);

PID_Data motor_pids[4] = {motor1,motor2,motor3,motor4}
